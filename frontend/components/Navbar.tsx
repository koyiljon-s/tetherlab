  ...
  return (
    <nav className="flex w-full items-center justify-between border-b border-[#2e2e2e] bg-[#1c1c1c] px-6 py-3">
      <div className="flex items-center gap-10">
        <span className="text-2xl font-bold tracking-tight">Tether<span className="text-white">Lab</span></span>
        <div className="flex items-center gap-6 text-[18px] text-zinc-600 dark:text-[#bebfc4]">
      ...
      <div className="flex items-center gap-3">
          <a
            href="/contact-us"
            className="inline-flex h-10 items-center justify-center rounded-full px-5 text-lg font-semibold bg-[#1c1c1c] border border-[#356cdb] text-white transition-colors"
          >
            Create Demo Wallet
          </a>
